...
### Q8: Are JSON Web Tokens (JWTs) encrypted by default?
**Answer:**
...
### Q9: What is the `alg: none` vulnerability in JWTs?
**Answer:**
...
### Q10: What is the role of the `state` parameter in OAuth 2.0?
**Answer:**
...
### Q11: What are the primary authentication factor categories in MFA?
**Answer:**
...
### Q12: What is LLMNR / NBT-NS Poisoning and how is it exploited?
**Answer:**
...
### Q14: What is the difference between a Capture Filter and a Display Filter in Wireshark?
**Answer:**
...
### Q15: What is the difference between Nmap `-sS` and `-sT` scans?
**Answer:**
